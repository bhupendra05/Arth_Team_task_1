...
""")
 ...
 Press 2:Redhat Linux""")
		...
		if int(img) ==1:
			...
			key = input()
			os.system("aws ec2 run-instances --image-id ami-0e306788ff2473ccb --subnet-id subnet-78003a10 --instance-type t2.micro --key-name {} --security-group-ids sg-060ae285029c964ec --count 1".format(key))
		elif int(img) == 2:
			print("Enter Your Key name: ",end ="")
			key = input()
			os.system("aws ec2 run-instances --image-id ami-052c08d70def0ac62 --subnet-id subnet-78003a10 --instance-type t2.micro --key-name {} --security-group-ids sg-060ae285029c964ec --count 1".format(key))
